...
const Home = () => {
  return (
    <div className="flex flex-col items-center">
      <main className=" relative mt-4 h-96 before:w-11/12 before:h-almostFull before:border-4 before:absolute before:content-[''] before:top-4 before:left-6 ">
      ...
      <section className="flex flex-wrap">
        ...
        ></ImgMainHome>
        <ImgMainHome image={torta9} alt={"torta decorada"}></ImgMainHome>
        <ImgMainHome image={torta3} alt={"torta decorada"}></ImgMainHome>
      </section>
